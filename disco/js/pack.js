...
/* harmony import */ var stringz__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! stringz */ "./node_modules/stringz/dist/index.js");
...
var title = (0,stringz__WEBPACK_IMPORTED_MODULE_2__.limit)(phrase, 30, '-') + '-';
...
function tick() {
  ...
  generateFavicon(); // Set color of different tab bars
  ...
  title = (0,stringz__WEBPACK_IMPORTED_MODULE_2__.substr)(title, 1) + (0,stringz__WEBPACK_IMPORTED_MODULE_2__.substr)(title, 0, 1);
  document.title = title;
  setTimeout(tick, 50);
}
...
function vibrate(event) {
  ...
  var success = window.navigator.vibrate(700);
...
function generateFavicon() {
  ...
  document.getElementById('favicon').setAttribute('href', faviconCanvas.toDataURL('image/x-icon'));
}
...
// @ts-ignore
var char_regex_1 = __importDefault(__webpack_require__(/*! char-regex */ "./node_modules/char-regex/index.js"));
/**
...
/******/ 	__webpack_require__("./src/sass/master.sass");
/******/ })()
;
